...
let rec step (c : config) : config =
  ...
  let vs', es' =
    ...
    | Plain e', vs ->
      ...
      | LocalSet x, v :: vs' ->
        local frame x := v; (* x-ésima variavel tem o valor v, avalia para o pointer daquela local *)
        vs', [] (* tira da stack e nao ha mais intruções depois --> este codigo vai ficar igual *) 
      ...
      | Load {offset; ty; sz; _}, I32 i :: vs' -> (* agr n interessa pq nao tamos a ver a heap*)
      ...
      | Store {offset; sz; _}, v :: I32 i :: vs' -> (* agr n interessa pq nao tamos a ver a heap*)
