...
/**
 * summ_is_symbolic - Verifies if concatenation of <length> bytes
 ...
 *
 */
void _solver_Concat(symbolic result, symbolic sym_var, symbolic sym_var2, unsigned int length1, unsigned int length2){
...
*/
void _solver_Extract(symbolic result, symbolic sym_var, unsigned int start, unsigned int end, unsigned int length){
...
*
*/
void _solver_ZeroExt(symbolic result, symbolic sym_var, unsigned int to_extend, unsigned int length){
...
* 
*/
void _solver_SignExt(symbolic result, symbolic sym_var, unsigned int to_extend, unsigned int length){
