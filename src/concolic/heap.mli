...
val load_bytes : t -> address -> int -> string * Expr.t

val store_bytes : t -> address -> string -> unit

val load_value : t -> address -> offset -> Ty.t -> Num.t * Expr.t

val store_value : t -> address -> offset -> Num.t * Expr.t -> unit

val load_packed :
  pack_size -> extension -> t -> address -> offset -> Ty.t -> Num.t * Expr.t

val store_packed : pack_size -> t -> address -> offset -> Num.t * Expr.t -> unit
